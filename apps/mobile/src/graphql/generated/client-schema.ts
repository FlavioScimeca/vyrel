...
import { TaskLabelsDocument as CollectionDocument2 } from "../../features/dashboard/task/graphql/queries";
...
export const graphqlClientRegistry = defineGraphqlClientRegistry({
  collections: {
    ...
    "TaskLabel": { query: CollectionDocument2, responseKey: "taskLabels", storeFieldName: "taskLabels" },
  },
  mutations: {
    "CreateTask": {
    ...
    "CreateTaskLabel": {
      "createTaskLabel": {"collectionVariablePaths":{"organizationId":["input","organizationId"]},"entityType":"TaskLabel","keyField":"id","kind":"create"},
    },
    "DeleteOrganization": {
